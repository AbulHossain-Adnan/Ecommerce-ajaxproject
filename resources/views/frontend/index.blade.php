                                    ...
                                    <div class="deals_timer d-flex flex-row align-items-center justify-content-start">
                                        ...
                                        <div class="deals_timer_content ml-auto">
                                            <div class="deals_timer_box clearfix" data-target-time="">
                                                ...
                                                <div class="deals_timer_unit">
                                                    <div id="deals_timer2_min" class="deals_timer_min">
                                                    </div>
                                                    <span>mins</span>
                                                </div>
                                                <div class="deals_timer_unit">
                                                    <div id="deals_timer2_sec" class="deals_timer_sec">
                                                    </div>
                                                    <span>secs</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="deals_timer d-flex flex-row align-items-center justify-content-start">
                                        ...
                                        <div class="deals_timer_content ml-auto">
                                            <div class="deals_timer_box clearfix" data-target-time="">
                                                ...
                                                <div class="deals_timer_unit">
                                                    <div id="deals_timer3_min" class="deals_timer_min">
                                                    </div>
                                                    <span>mins</span>
                                                </div>
                                                <div class="deals_timer_unit">
                                                    <div id="deals_timer3_sec" class="deals_timer_sec">
                                                    </div>
                                                    <span>secs</span>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="product_content">
                                            ...
                                            <div class="product_name">
                                                <div><a href="product.html">{{ $item->brand->brand_name }}</a></div>
                                            </div>
                            ...
                            <div class="featured_slider slider">
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset('product_images/'.$item->image_one) }}" width="125",height="125">
                                        </div>
                                        <div class="product_content">
                                             @if($item->discount_price == null)
                                              <div class="product_price discount">{{ $item->selling_price }}</div>
                        ...
                        <div class="row fill_height">
                            <div class="col-lg-4 col-md-6 fill_height">
                                <div class="banner_2_content">
                                    <div class="banner_2_category"><h4></h3>{{ $item->category->category_name }}</h4></div>
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image">
                                            <img src="{{ asset('product_images/'.$item->image_one) }}" style="width: 250px;height: 300px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="arrivals_slider_item">
                                        ...
                                        <div
                                            ...
                                            <div class="product_content">
                                                <div class="product_price">$379</div>
                                                <div class="product_name">
                                                    <div><a href="product.html">Nokia 3310(2017)...</a>
                                                    </div>
                                                </div>
                                                <div class="product_extras">
                                                    <div class="product_color">
